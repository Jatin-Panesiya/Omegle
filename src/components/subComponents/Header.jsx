    ...
    <div className="flex items-center justify-between px-[3%] sm:px-[9%] py-4  bg-white sticky top-0 z-10  ">
      <div>
        <Image
          src={"/LOGO.svg"}
          alt="LOGO"
          className="700:w-60 300:w-40 400:w-44 500:w-48 600:w-52  w-36 cursor-pointer"
      ...
      {/* Mobile */}
      <div className="bg-[#ff7f00] text-white font-bold px-5 text-base  700:text-xl text-center py-0.5  1000:hidden absolute  left-0 w-full   500:top-20 300:top-[70px] top-16">
        <p>Talk to strangers!</p>
      </div>
